...
public sealed class ViewerPrivacyServiceTests
{
    ...
    public void EveryIdentityBearingColumn_IsDeclaredHandledOrDeliberatelyExcluded()
    {
        ...
        var handled = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "BingoEvidence.ParticipantDisplayName",
            "BingoEvidence.ParticipantLogin",
            "BingoEvidence.ParticipantTwitchUserId",
            "BingoModerationAudit.ActorLogin",
            "BingoModerationAudit.ActorTwitchUserId",
            "BingoParticipant.DisplayName",
            "BingoParticipant.Login",
            "BingoParticipant.TwitchUserId",
            "BingoTemplateRevision.CreatedByLogin",
            "BingoTemplateRevision.CreatedByTwitchUserId",
            "BingoWinRecipient.DisplayName",
            "BingoWinRecipient.Login",
            "BingoWinRecipient.TwitchUserId",
