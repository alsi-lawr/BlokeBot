...
{
    [Test]
    public async Task CooperativeGameSwitch_LoadingViewerCatalog_OmitsRaidCommandWhileOff()
    {
        ...
        enabled.Names.ShouldContain("!raid");
        disabled.Names.ShouldNotContain("!raid");
    }
