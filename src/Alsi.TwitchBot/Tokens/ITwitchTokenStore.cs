...
public interface ITwitchTokenStore
{
    ...
    Task<TwitchTokenSet?> LoadAsync(string path, CancellationToken cancellationToken);
    ...
    Task SaveAsync(string path, TwitchTokenSet tokenSet, CancellationToken cancellationToken);
}
