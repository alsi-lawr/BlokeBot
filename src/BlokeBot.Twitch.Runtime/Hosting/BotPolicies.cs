...
/// </summary>
public sealed record BotPolicyOptions
{
...
public sealed record BotPolicies
{
    ...
    public static BotPolicies BindRequired(IConfiguration configuration)
    {
        ArgumentNullException.ThrowIfNull(configuration);

        var policies = configuration.GetSection("Policies");
        return FromOptions(
            new BotPolicyOptions
            {
    ...
    public static BotPolicies FromOptions(
        BotPolicyOptions options,
