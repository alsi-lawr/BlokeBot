...
internal static class SimulationViewCatalog
{
    ...
    >(StringComparer.Ordinal)
    {
        ...
        ["raid"] = "/raid",
        ["public-raid"] =
            $"/raid/{FakeTwitch.FakeTwitchScenarioDefinition.ReadyDashboard.AuthorizedUser.Login}",
        ["passports"] = "/passports",
        ["public-passport"] =
        ...
        ["plugin-installation"] = "/plugins/community.link-queue/settings",
        ["plugin-collection"] = "/plugins/community.link-queue/features/collection",
        ["automation-events"] = "/automations/events",
        ["automations"] = "/automations",
        ["overlays"] = "/overlays#sources",
        ["admin"] = "/admin",
        ["plugin-admin"] = "/admin#plugins",
