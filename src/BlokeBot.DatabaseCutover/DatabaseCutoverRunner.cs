...
{
    private const string _currentSqliteMigration = "20260907001053_AutomationTraces";
    private const string _currentPostgreSqlMigration = "20260907001120_AutomationTraces";
