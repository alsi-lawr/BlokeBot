...
{
    private const string _currentSqliteMigration = "20260906180127_AutomationScenarios";
    private const string _currentPostgreSqlMigration = "20260906180403_AutomationScenarios";
