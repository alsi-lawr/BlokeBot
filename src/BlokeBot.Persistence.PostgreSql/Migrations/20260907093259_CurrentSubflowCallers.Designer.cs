...
namespace BlokeBot.Persistence.PostgreSql.Migrations
{
    ...
    [Migration("20260907093259_CurrentSubflowCallers")]
    partial class CurrentSubflowCallers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationFlowRun", b =>
                {
                    ...
                    b.HasIndex("FlowId", "SourceNodeId", "SourceOccurrenceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationSubflow", b =>
                {
                    ...
                    b.ToTable("automation_subflows", (string)null);
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationSubflowCallerReference", b =>
                {
                    b.Property<Guid>("NodeId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationSubflowRevisionRecord", b =>
                {
                    ...
                    b.HasIndex("HostId", "SubflowId", "Revision")
                        .IsUnique();
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationSubflowRunReference", b =>
                {
                    ...
                    b.HasKey("RunId", "RevisionId");

                    b.HasIndex("HostId", "RevisionId");

                    b.ToTable("automation_subflow_run_references", (string)null);
                });
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.CommandAlias", b =>
                {
                    ...
                    b.HasIndex("HostId", "GuessRoundProfileId", "Alias")
                        .IsUnique()
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginAutomationInstantiationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EnableOperationId", "TemplateId")
                        .IsUnique();

                    b.HasIndex("PluginId", "FeatureId", "HostId", "TemplateId", "TemplateHash");

                    b.ToTable("plugin_automation_instantiations", (string)null);
                });
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginLifecycleRecord", b =>
                {
                    b.Property<string>("PluginId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.ToTable("plugin_lifecycles", null, t =>
                        {
                            t.HasCheckConstraint("CK_plugin_lifecycles_ActiveRuntime", "(\"ActiveVersion\" IS NULL AND \"ActiveTag\" IS NULL AND \"ActiveOperationId\" IS NULL AND \"ActivePackageOperationId\" IS NULL AND \"ActiveGeneration\" IS NULL) OR (\"ActiveVersion\" IS NOT NULL AND \"ActiveTag\" IS NOT NULL AND \"ActiveOperationId\" IS NOT NULL AND \"ActivePackageOperationId\" IS NOT NULL AND \"ActiveGeneration\" > 0)");

                            t.HasCheckConstraint("CK_plugin_lifecycles_FailureCode", "\"FailureCode\" IS NULL OR \"FailureCode\" IN ('PreparationRejected', 'PreparationFailed', 'MigrationFailed', 'ActivationFailed', 'WorkerStartFailed', 'WorkerDisposalFailed', 'WorkerExited', 'DrainTimedOut', 'CancellationFailed', 'RemovalFailed', 'RecoveryPackageUnavailable', 'RecoveryFailed', 'GenerationExhausted')");

                            t.HasCheckConstraint("CK_plugin_lifecycles_FaultShutdown", "\"Phase\" <> 'Faulted' OR \"ActiveOperationId\" IS NULL OR (\"FaultedFrom\" = 'Active' AND \"ActiveVersion\" = \"SelectedVersion\" AND \"ActiveTag\" = \"SelectedTag\" AND \"ActiveOperationId\" = \"OperationId\" AND \"ActivePackageOperationId\" = \"SelectedPackageOperationId\" AND \"ActiveGeneration\" = \"SelectedGeneration\")");

                            t.HasCheckConstraint("CK_plugin_lifecycles_FaultedFrom", "(\"Phase\" = 'Faulted' AND \"FaultedFrom\" IS NOT NULL AND \"FaultedFrom\" IN ('Preparing', 'Migrating', 'Activating', 'Active', 'Draining', 'Removing')) OR (\"Phase\" <> 'Faulted' AND \"FaultedFrom\" IS NULL)");

                            t.HasCheckConstraint("CK_plugin_lifecycles_OperationKind", "\"OperationKind\" IN ('Activate', 'Remove', 'Replace', 'Restart')");

                            t.HasCheckConstraint("CK_plugin_lifecycles_OutcomeCode", "\"OutcomeCode\" IN ('Preparing', 'Migrating', 'Activated', 'Removed', 'RestartScheduled', 'Restarted', 'Faulted', 'Recovered')");

                            t.HasCheckConstraint("CK_plugin_lifecycles_Phase", "\"Phase\" IN ('Preparing', 'Migrating', 'Activating', 'Active', 'Draining', 'Removing', 'Removed', 'Faulted')");

                            t.HasCheckConstraint("CK_plugin_lifecycles_SelectedGeneration", "\"SelectedGeneration\" > 0");

                            t.HasCheckConstraint("CK_plugin_lifecycles_SelectedPackageOperation", "\"SelectedPackageOperationId\" <> '00000000-0000-0000-0000-000000000000'");
                        });
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceCatalogEntryRecord", b =>
                {
                    b.Property<string>("PluginId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("plugin_marketplace_catalog_entries", null, t =>
                        {
                            t.HasCheckConstraint("CK_plugin_marketplace_catalog_entries_SnapshotId", "\"SnapshotId\" = 1");
                        });
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceCatalogMediaRecord", b =>
                {
                    b.Property<string>("PluginId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("plugin_marketplace_catalog_media", (string)null);
                });
                    ...
                    b.ToTable("plugin_marketplace_catalog_state", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_plugin_marketplace_catalog_state_Success", "(\"SchemaVersion\" IS NULL AND \"FetchedAtUtc\" IS NULL AND \"SourceETag\" IS NULL AND \"SourceModifiedAtUtc\" IS NULL) OR (\"SchemaVersion\" = 1 AND \"FetchedAtUtc\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceCatalogTagRecord", b =>
                {
                    b.Property<string>("PluginId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("plugin_marketplace_catalog_tags", (string)null);
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceCatalogTargetRecord", b =>
                {
                    b.Property<string>("PluginId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("plugin_marketplace_catalog_targets", (string)null);
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceReceiptRecord", b =>
                {
                    b.Property<string>("PluginId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.ToTable("plugin_marketplace_receipts", null, t =>
                        {
                            t.HasCheckConstraint("CK_plugin_marketplace_receipts_Operation", "\"Operation\" IN ('Install', 'Update', 'Remove', 'Restart')");

                            t.HasCheckConstraint("CK_plugin_marketplace_receipts_Release", "(\"DeclaredVersion\" IS NULL AND \"MutableTag\" IS NULL) OR (\"DeclaredVersion\" IS NOT NULL AND \"MutableTag\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.ViewerPassportStreamAttendance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("HostId", "StreamSessionId");

                    b.HasIndex("HostId", "PassportId", "StreamSessionId")
                        .IsUnique();

                    b.ToTable("viewer_passport_stream_attendance", (string)null);
                });

            modelBuilder.Entity("BlokeBot.Persistence.Models.ViewerPassportStreamSession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("HostId", "TwitchStreamId")
                        .IsUnique();

                    b.HasIndex("HostId", "ContinuityGeneration", "StartedAtUtc", "TwitchStreamId");

                    b.ToTable("viewer_passport_stream_sessions", (string)null);
                });
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationSubflowCallerReference", b =>
                {
                    b.HasOne("BlokeBot.Persistence.Models.AutomationFlowNode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.AutomationSubflowRunReference", b =>
                {
                    b.HasOne("BlokeBot.Persistence.Models.AutomationFlowRun", null)
                        .WithMany()
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceCatalogEntryRecord", b =>
                {
                    b.HasOne("BlokeBot.Persistence.Models.PluginMarketplaceCatalogStateRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginMarketplaceCatalogMediaRecord", b =>
                {
                    b.HasOne("BlokeBot.Persistence.Models.PluginMarketplaceCatalogEntryRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.ViewerPassportStreamAttendance", b =>
                {
                    b.HasOne("BlokeBot.Persistence.Models.ViewerPassport", "Passport")
                        .WithMany()
                        .HasForeignKey("HostId", "PassportId")
                        .HasPrincipalKey("HostId", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlokeBot.Persistence.Models.ViewerPassportStreamSession", "StreamSession")
                        .WithMany()
                        .HasForeignKey("HostId", "StreamSessionId")
                        .HasPrincipalKey("HostId", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
