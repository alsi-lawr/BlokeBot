...
namespace BlokeBot.Persistence.Migrations
{
    ...
    [Migration("20260823180232_v0.13.0_PluginLifecycleFaultShutdown")]
    partial class v0130_PluginLifecycleFaultShutdown
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("plugin_lifecycles", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_plugin_lifecycles_FaultShutdown", "\"Phase\" <> 'Faulted' OR \"ActiveOperationId\" IS NULL OR \"FaultedFrom\" = 'Active'");

                            t.HasCheckConstraint("CK_plugin_lifecycles_FaultedFrom", "\"FaultedFrom\" IS NULL OR \"FaultedFrom\" IN ('Preparing', 'Migrating', 'Activating', 'Active', 'Draining', 'Removing', 'Removed', 'Purging', 'Faulted')");
