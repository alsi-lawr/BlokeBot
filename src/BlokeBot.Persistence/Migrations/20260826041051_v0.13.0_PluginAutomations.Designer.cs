...
namespace BlokeBot.Persistence.Migrations
{
    ...
    [Migration("20260826041051_v0.13.0_PluginAutomations")]
    partial class v0130_PluginAutomations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginLifecycleOutcomeRecord", b =>
                {
                    ...
                    b.ToTable("plugin_lifecycle_outcomes", null, t =>
                        {
                            t.HasCheckConstraint("CK_plugin_lifecycle_outcomes_FailureCode", "\"FailureCode\" IS NULL OR \"FailureCode\" IN ('PreparationRejected', 'PreparationFailed', 'MigrationFailed', 'ActivationFailed', 'WorkerStartFailed', 'WorkerDisposalFailed', 'WorkerExited', 'DrainTimedOut', 'CancellationFailed', 'RemovalFailed', 'PurgeFailed', 'RecoveryPackageUnavailable', 'RecoveryFailed', 'GenerationExhausted')");

                            t.HasCheckConstraint("CK_plugin_lifecycle_outcomes_OutcomeCode", "\"OutcomeCode\" IN ('Preparing', 'Migrating', 'Activated', 'Removed', 'Purged', 'RestartScheduled', 'Restarted', 'Faulted', 'Recovered')");
                        });
                });
                    ...
                    b.ToTable("plugin_lifecycles", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_plugin_lifecycles_FaultedFrom", "(\"Phase\" = 'Faulted' AND \"FaultedFrom\" IS NOT NULL AND \"FaultedFrom\" IN ('Preparing', 'Migrating', 'Activating', 'Active', 'Draining', 'Removing', 'Purging')) OR (\"Phase\" <> 'Faulted' AND \"FaultedFrom\" IS NULL)");

                            t.HasCheckConstraint("CK_plugin_lifecycles_OperationKind", "\"OperationKind\" IN ('Activate', 'Remove', 'Purge', 'Restart')");

                            t.HasCheckConstraint("CK_plugin_lifecycles_OutcomeCode", "\"OutcomeCode\" IN ('Preparing', 'Migrating', 'Activated', 'Removed', 'Purged', 'RestartScheduled', 'Restarted', 'Faulted', 'Recovered')");

                            t.HasCheckConstraint("CK_plugin_lifecycles_Phase", "\"Phase\" IN ('Preparing', 'Migrating', 'Activating', 'Active', 'Draining', 'Removing', 'Removed', 'Purging', 'Faulted')");
