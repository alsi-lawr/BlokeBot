...
namespace BlokeBot.Persistence.Migrations
{
    ...
    [Migration("20260731110140_v0.6.0_EventFeedOverlay")]
    partial class v060_EventFeedOverlay
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("overlay_instances", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_overlay_instances_ConfigurationJson", "length(ConfigurationJson) BETWEEN 1 AND 4096 AND json_valid(ConfigurationJson) AND json_type(ConfigurationJson, '$.schemaVersion') = 'integer' AND json_extract(ConfigurationJson, '$.schemaVersion') = 1");

                            t.HasCheckConstraint("CK_overlay_instances_Name", "length(Name) BETWEEN 1 AND 128");

                            t.HasCheckConstraint("CK_overlay_instances_Type", "Type IN ('cue-player', 'empty', 'event-feed', 'giveaway', 'guessing')");
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.OverlayMediaAsset", b =>
                {
                    ...
                    b.ToTable("overlay_media_assets", null, t =>
                        {
                            t.HasCheckConstraint("CK_overlay_media_assets_ContentType", "ContentType IN ('video/mp4', 'audio/mpeg')");
