...
namespace BlokeBot.Persistence.Migrations
{
    ...
    [Migration("20260826143119_v0.13.0_PluginLifecycleReplacement")]
    partial class v0130_PluginLifecycleReplacement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlokeBot.Persistence.Models.PluginLifecycleRecord", b =>
                {
                    ...
                    b.ToTable("plugin_lifecycles", null, t =>
                        {
                            t.HasCheckConstraint("CK_plugin_lifecycles_ActiveRuntime", "(\"ActiveVersion\" IS NULL AND \"ActiveTag\" IS NULL AND \"ActiveOperationId\" IS NULL AND \"ActiveGeneration\" IS NULL) OR (\"ActiveVersion\" IS NOT NULL AND \"ActiveTag\" IS NOT NULL AND \"ActiveOperationId\" IS NOT NULL AND \"ActiveGeneration\" > 0)");
                            ...
                            t.HasCheckConstraint("CK_plugin_lifecycles_FaultShutdown", "\"Phase\" <> 'Faulted' OR \"ActiveOperationId\" IS NULL OR (\"FaultedFrom\" = 'Active' AND \"ActiveVersion\" = \"SelectedVersion\" AND \"ActiveTag\" = \"SelectedTag\" AND \"ActiveOperationId\" = \"OperationId\" AND \"ActiveGeneration\" = \"SelectedGeneration\")");
